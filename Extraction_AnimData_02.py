...
# ==========================================================
# Export Logic (ROW-BASED, FRAME HEADER)
# ==========================================================
def export_textures(options, meta, collect_all):
    ...
    for mat in materials:
        for file_node in get_file_textures_from_material(mat):
            ...
            frames = []
            data_rows = {opt: [] for opt in options}
            last_state = None
            ...
            with open(csv_path, "w", newline="") as f:
                ...
                # Data rows
                for opt in options:
                    writer.writerow([opt] + data_rows[opt])
...
def run_export():
    ...
    export_textures(options, {}, collect_all)
